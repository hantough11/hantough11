<?php	
	...
	$new_file_name = 'gs://popon-lg/'.$user_email.'/cell_images/'.$file_name;
	...
	echo ($file_name);
	echo "<br>";
	echo ($object_image_file[$number_of_cell_images]);
	echo "<br>";
	echo ($object_image_url[$number_of_cell_images]);
	echo "<br>";
	...
	echo("<script language='javascript'>opener.window.php_complete_cell_images_upload();</script>");
